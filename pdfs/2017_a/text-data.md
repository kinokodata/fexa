...
| 図記号 | 説明 |
|--------|------|
| ![論理積素子](./images/1_1.png) | 論理積素子（AND） |
| ![否定論理積素子](./images/1_2.png) | 否定論理積素子（NAND） |
| ![論理和素子](./images/1_3.png) | 論理和素子（OR） |
| ![否定論理和素子](./images/1_4.png) | 否定論理和素子（NOR） |
| ![排他的論理和素子](./images/1_5.png) | 排他的論理和素子（XOR） |
| ![論理一致素子](./images/1_6.png) | 論理一致素子 |
| ![バッファ](./images/1_7.png) | バッファ |
| ![論理否定器](./images/1_8.png) | 論理否定器（NOT） |
| ![スリーステートバッファ](./images/1_9.png) | スリーステートバッファ |
