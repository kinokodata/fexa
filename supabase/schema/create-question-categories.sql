...
CREATE TABLE public.question_categories (
    ...
    relevance_score numeric DEFAULT 1.0 CHECK (relevance_score >= 0.0 AND relevance_score <= 1.0),
...
CREATE TABLE public.question_tags (
    ...
    relevance_score numeric DEFAULT 1.0 CHECK (relevance_score >= 0::numeric AND relevance_score <= 1::numeric),
  is_primary boolean DEFAULT false,
  created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
